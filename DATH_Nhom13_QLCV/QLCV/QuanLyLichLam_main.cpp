...
int main() {
    ...
    do {
        ...
        case 5:
            cout << "\n Chon cach sua:"
                << "\n1. Thay doi toan bo thong tin cua 1 cong viec."
                << "\n2. Thay doi ten cua 1 cong viec."
                << "\n3. Thay doi ngay ket thuc cua 1 cong viec."
                << "\n4. Thay doi trang thai cua 1 cong viec."
                << "\n0. Thoat ra menu.";
            cout << "\nNhap lua chon: ";
            cin >> luaChonMenu;
            //xuat_DanhSachCongViec(dscv);
